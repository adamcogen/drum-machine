...
function getGuiConfigurations(hideIcons=false) {
    return {
        ...
        helpText: {
            ...
            changeRowVolume: "click and drag up and down to adjust volume for all notes in row. click to mute row.",
            changeRowVolumeMuted: "click and drag up and down to adjust volume for all notes in row. row is muted -- click to unmute row.",
