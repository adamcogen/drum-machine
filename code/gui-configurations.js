...
function getGuiConfigurations(hideIcons=false) {
    return {
        ...
        helpText: {
            ...
            multiShift: "multi-shift tool: click+drag to shift multiple types of objects at the same time. +ctrl for beat lines; +alt for notes; +cmd for visual reference lines."
        }
    }
}