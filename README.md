...
- Choose from a number of built-in drum kits for live audio output.
- Output live MIDI to any DAW or MIDI device, and export patterns to MIDI files.
...
Running the drum machine locally allows you to add your own custom drum kits, change default MIDI output pitches and velocities, update the configuration of the GUI, or make other code changes.
